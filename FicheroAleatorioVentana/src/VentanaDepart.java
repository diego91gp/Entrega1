...
/**
 * Clase VentanaDepart: Esta clase dibuja la ventana para la gestión de los
 * datos del fichero AleatorioDep.dat
 * 
 * @author AARRMM 2013
 * @version 1-2013
 */
public class VentanaDepart extends JFrame implements ActionListener, iVentanaDepart {
	...
	public void actionPerformed(ActionEvent e) {
		...
		String NOEXISTE_DEPART = " DEPARTAMENTO NO EXISTEEE.";
		if (e.getSource() == borra)
			borra(NOEXISTE_DEPART);
		if (e.getSource() == modif)
			modificacion(NOEXISTE_DEPART);
	...
	@Override
	public void modificacion(String NOEXISTE_DEPART) {
		int dep;
		int confirm;
	...
	@Override
	public void borra(String NOEXISTE_DEPART) {
		int dep;
		int confirm;
	...
	/**
	 * Método verporconsola Este método visualiza los datos del fichero en la
	 * consola.
	 * 
	 * @throws IOException
	 */
	...
	/**
	 * Método consultar Este método consulta los datos de un departamento que se
